      ...
      <Link href="/chat"> <div className={styles.logoRow}>
        ...
        <h1 className={styles.title}>{t('how_ai_works_title')}</h1>
          ...
          <p>
            ...
            <a href="/user-guidelines">{t('how_ai_works_user_guidelines_link')}</a>
            {t('how_ai_works_conclusion_continued')}
          </p>

          <p>{t('how_ai_works_academic_paper_intro')}</p>

          <p>{t('how_ai_works_academic_paper_citation')}{' '}<strong>{t('how_ai_works_academic_paper_citation_title')}</strong>{' '}{t('how_ai_works_academic_paper_citation_cont')}{'['}<a href="https://arxiv.org/abs/2409.00009">{t('how_ai_works_arxiv_link')}</a>{']'}</p>
          ...
          <ul>
            <li>
              ...
              <a href="https://arxiv.org/pdf/2305.14928">{t('how_ai_works_arxiv_link')}</a>
              {' '}{t('how_ai_works_why_it_works_cont')}
            </li>
            <li>
              {t('how_ai_works_source_reliability')}{' '}
              <a href="https://www.google.com/url?q=https://doi.org/10.1093/pnasnexus/pgad286&sa=D&source=docs&ust=1738350980635922&usg=AOvVaw2L0zAoYLG6TpmtU-5y8JLS">
